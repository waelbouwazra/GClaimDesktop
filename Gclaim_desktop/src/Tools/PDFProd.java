...
public class PDFProd {
 ...
 public void pdfGeneration() throws FileNotFoundException, DocumentException, MalformedURLException, IOException, URISyntaxException {
        ...
        List<Produit> order= ps.ShowProduit();
       
        PdfWriter.getInstance(document, new FileOutputStream (new File ("produits.pdf")));
        document.open();
        ...
        Paragraph titre =new Paragraph (" Gclaim produits");
...
//        document.newPage();
        ...
        c1 = new PdfPCell(new Phrase("quantitée"));
        c1.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(c1);
        ...
        for (Produit o:order) {
            table.addCell(String.valueOf (o.getNom_produit()));
            table.addCell(String.valueOf (o.getDescription()));
            table.addCell(String.valueOf (o.getPrix_produit()));
            table.addCell(String.valueOf (o.getQte_produit()));
