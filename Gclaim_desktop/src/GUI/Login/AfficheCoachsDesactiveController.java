 ...
 * @author souma
 */
public class AfficheCoachsDesactiveController implements Initializable {
 ...
 @Override
    ...
    txtlistusers.setItems(items);
      ObservableList<Integer> langs = FXCollections.observableArrayList(rs.getIdcoachsdesactiver());
    ...
    private void deleteuser(ActionEvent event) {
      rs.activeruncompte(comboBoxID.getValue());
      ObservableList<Utilisateur> items =FXCollections.observableArrayList();
        List<Utilisateur> listuser = rs.affichecoachdesactiver();
        for(Utilisateur r : listuser) {
            String ch = r.toString();
