 ...
 * @author souma
 */
public class AffichetusersActiveController implements Initializable {
 ...
 @Override
    ...
    txtlistusers.setItems(items);
      ObservableList<Integer> langs = FXCollections.observableArrayList(rs.getIdusersactiver());
