 ...
 * @author souma
 */
public class AfficheuserDesactiveController implements Initializable {
 ...
 @Override
    ...
    txtlistusers.setItems(items);
      ObservableList<Integer> langs = FXCollections.observableArrayList(rs.getIdusersdesactiver());
